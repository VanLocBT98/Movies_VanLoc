...
export default function New(props) {
  ...
  useEffect( () =>{
   (hiden ? divRef.current.style.display='none' : divRef.current.style.display='block')

  },[hiden])
  useEffect( () =>{
    (hiden ? btnRef.current.style.display='block' : btnRef.current.style.display='none')
    ...
    <section id="news">
      <div  className="container adsNews">
        <ul className="nav nav-tabs mb-3">
          <li ><a data-toggle="tab" className="active" href="#cinemaE">Điện Ảnh 24h</a></li>
          <li ><a data-toggle="tab" href="#cinemaR">Review</a></li>
          <li><a data-toggle="tab" href="#cinemaO">Khuyến Mãi</a></li>
        </ul>
        <div ref={divRef} className="tab-content ">
        ...
        <button className ='btn btn-rutgon' onClick={()=>{setHiden(true)}}>Rút Gọn</button>
        </div>
        </div>
      </div>
      <button ref= {btnRef} className ='btn' onClick={()=>{setHiden(false)}}>Xem thêm</button>
